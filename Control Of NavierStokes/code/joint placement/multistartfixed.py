...
from helpers import (T, _block_is, eye_scaled, rel_diff, matmul_sparse, descriptor_matrix_boyd_openloop, hamiltonian_matrix_boyd_openloop, energy_identity_check, build_S, make_lu_ksp, rayleigh_quotient_check ) 
...
from AomegaCtx import (AomegaCtx, make_Aomega_shell)
